...
The aim of the module is to provide a comprehensive grounding in MySQL.
...
- The software must be downloaded and run on a machine as follows:
	...
	``git clone https://github.com/SeanOhAileasa/adb-MySQL.git``

    - Run Jupyter Notebooks from the command line with the following:

	``jupyter notebook``

    - Open notebook - ``adb-MySQL.ipynb``
...
- An alternative to downloading and running on a local machine with all features included (links/equation tag number etc) can view via [nbviewer](https://nbviewer.jupyter.org/github/SeanOhAileasa/adb-MySQL/blob/main/adb-MySQL.ipynb).
